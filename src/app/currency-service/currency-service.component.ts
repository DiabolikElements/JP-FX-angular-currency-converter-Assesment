...
//import { CURRENCIES } from 'src/app/mock-currency'; - was only used for mock local testing
  ...
  public getCurrenciesPromise() {
    ...
    if(this.currencies.length==0)
    {
      this.http.get<any>('https://open.er-api.com/v6/latest/USD').subscribe(data => {
         //  this.http.get<any>('https://fcsapi.com/api-v3/forex/candle?symbol=EUR/USD,USD/JPY,GBP/CHF&period=1h&access_key=API_KEY').subscribe(data => { new api approach
